...
RESTAURANTS = [
    ...
    {'id': 3, 'title': '푸른솔 학생식당', 'campus': 'se', 'path': 'ph', 'icon': 'utensils', 'color': '#d97706', 'mealsSemester': ['아침', '점심', 'One-Dish', '무인판매'], 'mealsVacation': ['아침', '점심'], 'mealsSemesterTime': ['08:30~10:00 (간편식: 09:00~10:00)', '11:00~14:30', '08:30~16:00', '14:30~소진시까지'], 'mealsVacationTime': ['11:00~14:00']},
    {'id': 4, 'title': '푸른솔 교직원식당', 'campus': 'se', 'path': 'pg', 'icon': 'cooking-pot', 'color': '#dc2626', 'mealsSemester': ['점심'], 'mealsVacation': ['점심'], 'mealsSemesterTime': ['11:00~14:00'], 'mealsVacationTime': ['11:00~14:00']},
    {'id': 5, 'title': '한국외대 인문관 식당', 'campus': 'se', 'path': 'his', 'icon': 'building-2', 'color': '#7c3aed', 'mealsSemester': ['아침', '점심', '저녁'], 'mealsVacation': ['아침', '점심', '저녁'], 'mealsSemesterTime': ['08:30~10:00 (간편식: 09:00~10:00)', '11:00~14:30', '17:00~18:30'], 'mealsVacationTime': ['11:00~14:00']},
    {'id': 6, 'title': '한국외대 교수회관 식당', 'campus': 'se', 'path': 'hgs', 'icon': 'landmark', 'color': '#0891b2', 'mealsSemester': ['점심'], 'mealsVacation': ['점심'], 'mealsSemesterTime': ['11:00~14:00'], 'mealsVacationTime': ['11:00~14:00']},
